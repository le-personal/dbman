...
function SSH(connectionOptions) {
	console.log("Using sshKey found in %s", connectionOptions.privateKey);
	if(fs.readFileSync(connectionOptions.privateKey)) {
		var options = {
			host: connectionOptions.host,
			port: connectionOptions.port,
			username: connectionOptions.username,
			privateKey: fs.readFileSync(connectionOptions.privateKey)
		...
		console.log("Error, cannot read the ssh file");
	}
}
